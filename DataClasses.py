# ---------------------------------------------------------- #
# Title: DataClasses (copied from Listing 06)
# Description: A module of data classes
# ChangeLog (Who,When,What):
# RRoot,1.1.2030,Created started script
# LHolmes, 9.7.2020, Updated line 93 (Was: self.__last_name).
# ---------------------------------------------------------- #
...
class Person:
    ...
    LHolmes, 9/7/202, Modified for Assignment09
    """
...
class Employee(Person):  # Inherits from Person
    ...
    def employee_id(self, value):
        if str(value).isnumeric():
            self.__employee_id = value  # modified to be employee id, not last name
        else:
